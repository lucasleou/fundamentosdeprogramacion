...
# -*- coding: utf-8 -*-
"""
Created on Tue Feb 23 21:24:48 2021
...
if (notaUnoEstudiante > notaDosEstudiante):
    if (notaUnoEstudiante > notaTresEstudiante):
        if(notaDosEstudiante > notaTresEstudiante):
               print(notaUnoEstudiante)
if (notaTresEstudiante > notaUnoEstudiante):
    if (notaTresEstudiante > notaDosEstudiante):
        if(notaDosEstudiante > notaUnoEstudiante):
               print(notaTresEstudiante)
if (notaDosEstudiante > notaUnoEstudiante):
    if (notaDosEstudiante > notaTresEstudiante):
        if(notaUnoEstudiante > notaTresEstudiante):
               print(notaDosEstudiante)
if (notaUnoEstudiante < notaDosEstudiante):
    if (notaUnoEstudiante < notaTresEstudiante):
        if(notaDosEstudiante < notaTresEstudiante):
               print(notaUnoEstudiante)
